...
dwelling_unit_details <- read_dta("D:/Data/NSS76/level7_dwelling.dta")
individual_member_details <- read_dta("D:/Data/NSS76/level2_individualLevel.dta")
Level3 <- read_dta("D:/Data/NSS76/Level3.dta")
level5_wash <- read_dta("D:/Data/NSS76/level5_wash.dta")
level6_health <- read_dta("D:/Data/NSS76/level6_health.dta")
...
house_cat_base_data=add_age_group(house_cat_base_data,individual_member_details)
